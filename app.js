...
inventorNames = inventors.map((inventor) => {
    ...
    // delete inventor.year; // this didn't work because it modified the original 'inventors' array ¯\_(ツ)_/¯
...
sortedByBirthYear = inventors.toSorted((a,b) => a.year - b.year);
...
firstLast = people.map((lastFirst) => {
    const nameArray = lastFirst.split(', ');
